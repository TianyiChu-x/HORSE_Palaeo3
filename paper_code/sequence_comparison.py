...
def main():
    ...
    sequence_names = ["Ground Truth", "CONOP"]
    range_fig, dist_fig = compare_range(
        ha_df=ha_df,
        sequences=[true_data, computed_data_by_conop_pp],
    ...
    compare_type = "horse-conop"
    sequence_names = ["Ground Truth", "CONOP + Teaser"]
    range_fig, dist_fig = compare_range(
        ha_df=ha_df,
        sequences=[true_data, computed_data_by_conop_pp],
        compare_type=compare_type,
    ...
    range_fig, dist_fig = compare_range(
        ha_df=ha_df,
        sequences=[true_data, data_computed.iloc[-1, 1:].to_numpy()],
        compare_type=compare_type,
        arrangement="fad",
        show_taxon_names=False,
        sequence_names=sequence_names,
