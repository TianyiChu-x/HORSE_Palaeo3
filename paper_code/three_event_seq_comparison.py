...
def compare_range(
    ...
    range_fig, ax = plt.subplots(figsize=(7.48, 4.16), dpi=300)
...
def main():
    ...
    # dyy data
    ha_path = r"../paper_data/DYY2_ha_output_temp.csv"
    ha_df = pd.read_csv(ha_path, encoding="utf_8_sig")
    sequence1_path = r'../paper_data/DYY2_cpp_teaser_conop_df.csv'
    sequence1 = pd.read_csv(sequence1_path, encoding='utf_8_sig')

    sequence2_path = r'../paper_data/DYY2_ha_output_temp.csv'
    ...
    range_fig.savefig("../paper_figs/DYY2_range_fig_cpp_teaser_horse.pdf", dpi=300, format="pdf")
    dist_fig.savefig("../paper_figs/DYY2_dist_fig_cpp_teaser_horse.pdf", dpi=300, format="pdf")
